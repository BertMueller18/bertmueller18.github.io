...
````powershell
New-ItemProperty HKLM:\SYSTEM\CurrentContolSet\Control\LSA\Kerberos\Parameters -Name "MaxTokenSize" -Value 65335 -PropertyType "DWORD"
New-ItemProperty HKLM:\SYSTEM\CurrentContolSet\Services\HTTP\Parameters -Name "MaxFieldLength" -Value 65335 -PropertyType "DWORD"
New-ItemProperty HKLM:\SYSTEM\CurrentContolSet\Services\HTTP\Parameters -Name "MaxRequestSize" -Value 40000 -PropertyType "DWORD"
````
